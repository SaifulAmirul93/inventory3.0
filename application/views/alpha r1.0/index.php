                                    ...
                                    <div class="col-md-12">
                                     ...
                                     <select name="category2" id="category2" class="form-control input-circle">
                                        ...
                                        <div class="col-lg-3" id="divSub2">
                                            <select class="form-control input-circle" id="subcategory2"  name="subcategory2"  disabled="" >
                                        <option value=-1"">Select Sub-category</option>
                                       
                                    </select>
                                        </div>
                                        <div class="col-lg-2">
                                            <input type="number" name="year" id="year" class="form-control" min="2016" placeholder="Year" disabled="">
                                        </div>
                                        <div class="col-lg-2">
