			...
			<tbody><tr>
				<td valign="top" mc:edit="headerBrand" id="templateContainerHeader">
					...
					<p style="text-align:center;margin:0;padding:0;">
						<img src="<?= base_url(); ?>/img/logo-5.png" style="max-width:600px;display:inline-block;">
					</p>
          <br>
				</td>
			</tr>
			<tr>
				<td align="center" valign="top">
                  ...
                  <tr>
                        ...
                        <p>
                          Hi Inventory,<br><br>
                          Herewith in this email is a Request Order information.
                        </p>  

												<h2>Request Detail</h2>
												<p>
                        
                          <?php $id=110000+$arr['id']; ?>
                          <?php $pur_id=$arr['id']; ?>
                          ...
                          <button type="button" class="btn btn-success btn-lg" title="Edit">Received</button></a>
                          </center></th>
                          </tr>
                          </tbody>
                          </table>
						...
						<tbody><tr>
							<td valign="top" width="100%" mc:edit="footer_unsubscribe">
								<p style="text-align:center;">
									<img src="<?= base_url(); ?>dist/img/favicon.png" style="max-width:600px;margin:0 auto 0 auto;display:inline-block;">
								</p>
