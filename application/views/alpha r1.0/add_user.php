                ...
                <!-- /.row -->
                 ...
                 <!-- /.col-lg-12 -->
                    <div class="col-lg-12">
                                 ...
                                 <form role="form" method="post" action="<?= site_url('Inventory/addUser'); ?>">
                                    ...
                                    <div class="form-group" id="p1">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <input type="password" name="pass" id = "password" class="form-control input-circle-left" placeholder="New Password" required="">
                                ...
                                <div class="form-group"> 
                                    <div class="form-group" id="p2">
                                        ...
                                        <div class="col-md-3">
                                                <input type="password" id = "pass2" class="form-control input-circle" placeholder="Re-password" required="">                                    
                                        </div>
                                    </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                           ...
                           <div class="clear" style="height: 50px;"></div>
                               <div class="row">
                                     <div class="form-group">
                                      <div class=" col-md-3">  
                                            <button type="submit" class="btn btn-primary" name="btnSubmit">Add User</button>
